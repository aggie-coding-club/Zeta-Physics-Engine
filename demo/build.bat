...
if %ENV% == GNU (
    ...
    echo dir
    g++ -g -std=c++14 ..\main.cpp ..\scene.cpp ..\shader.cpp ..\entity.cpp ..\renderer.cpp ..\app.cpp -o app -I..\..\include -L..\..\libs -l:libglfw3.a -l:libfreetype.a -lOpengl32
)

if %ENV% == MSVC (
    @REM Compiling with MSVC
    cl /std:c++17  ..\main.cpp ..\scene.cpp ..\shader.cpp ..\entity.cpp ..\renderer.cpp ..\app.cpp^
