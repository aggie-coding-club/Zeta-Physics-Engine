...
//     ZMath::Vec3D AABB::getMin() { return rb.pos - halfSize; };
//     ZMath::Vec3D AABB::getMax() { return rb.pos + halfSize; };
...
//     ZMath::Vec3D AABB::getMin() const { return rb.pos - halfSize; }
//     ZMath::Vec3D AABB::getMax() const { return rb.pos + halfSize; }
